...
void createRelationForward_0_To_4999();
void createRelationForward_SparseRelations();
void createRelationForward_LargeSizeToForcesplitNon_leafNode();
void intTests();
void intTestsForTest4();
void intTestsForTest5();
void intTestsForTest6();
void intTestsForTest7();
int intScan(BTreeIndex *index, int lowVal, Operator lowOp, int highVal, Operator highOp);
void indexTests();
void indexTestsForTest4();
void indexTestsForTest5();
void indexTestsForTest6();
void indexTestsForTest7();
void test1();
void test2();
void test3();
void test4();
...
void test4()
{
	...
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationForward_0_To_4999" << std::endl;
	createRelationForward_0_To_4999();
	indexTestsForTest4();
	deleteRelation();
}
...
void test5()
{
	//  This criterion is linked to a Learning Outcome Additional B+ Tree Test: Sparse relations with size of 3000, instead of relations with consecutive numbers.
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationForward_SparseRelations" << std::endl;
	createRelationForward_SparseRelations();
	indexTestsForTest5();
	// deleteRelation();
}
...
void test6()
{
	//  This criterion is linked to a Learning Outcome Additional B+ Tree Test: reopen an index on an existing one.
	std::cout << "--------------------" << std::endl;
...
void test7()
{
	//  This criterion is linked to a Learning Outcome Additional B+ Tree Test: construct tree with relations of large size to force the non-leaf node split
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationForward_LargeSizeToForcesplitNon_leafNode" << std::endl;
	createRelationForward_LargeSizeToForcesplitNon_leafNode();
	indexTestsForTest7();
	deleteRelation();
}
...
void intTestsForTest5()
{
	...
	// run some tests
	checkPassFail(intScan(&index, 3000, GTE, 4000, LTE), 501);
}
...
void intTestsForTest6()
{
	...
	// run some tests
	checkPassFail(intScan(&index, 2500, GT, 2800, LTE), 150);
}
...
void intTestsForTest7()
{
	...
	// run some tests
	checkPassFail(intScan(&index, 350006, GTE, 351009, LTE), 1004);
}
