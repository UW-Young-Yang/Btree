...
class BTreeIndex {
 ...
 public:
  ...
  PageKeyPair<int> *insertHelper(RIDKeyPair<int> leafPair, PageId node, bool isLeaf);

  void insertLeaf(RIDKeyPair<int> leafPair, LeafNodeInt *Node);

  void insertNonLeaf(PageKeyPair<int> nonLeafPair, NonLeafNodeInt *Node);

  PageKeyPair<int> *splitLeaf(RIDKeyPair<int> leafPair, PageId nodeId);

  PageKeyPair<int> *splitNonLeaf(PageKeyPair<int> *nonLeafPair, PageId nodeId);

  PageKeyPair<int> *pushUp(PageId leftNodeId, PageId rightNodeId, int key);
